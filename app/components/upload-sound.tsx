  ...
  return (
    <Card className="w-full max-w-md mx-auto mb-8">
      <CardHeader>
        ...
        <CardDescription>Add your own sounds to the sound board</CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter className="flex justify-between">
        <Button type="button" variant="outline" onClick={resetForm} disabled={isUploading || (!file && !displayName)}>
          <X className="mr-2 h-4 w-4" />
          Clear
        </Button>
        <Button type="submit" onClick={handleSubmit} disabled={isUploading || !file || !displayName.trim()}>
          {isUploading ? (
            <>
